...
export class RepoDriver extends ethereum.SmartContract {
  ...
  setStreams(
    ...
    balanceDelta: BigInt,
    newReceivers: Array<RepoDriver__setStreamsInputNewReceiversStruct>,
    maxEndHint1: BigInt,
    maxEndHint2: BigInt,
    transferTo: Address
  ): BigInt {
...
export class InitializeAnyApiOperatorCall extends ethereum.Call {
  get inputs(): InitializeAnyApiOperatorCall__Inputs {
    return new InitializeAnyApiOperatorCall__Inputs(this);
  }

  get outputs(): InitializeAnyApiOperatorCall__Outputs {
    return new InitializeAnyApiOperatorCall__Outputs(this);
  }
}

export class InitializeAnyApiOperatorCall__Inputs {
  _call: InitializeAnyApiOperatorCall;

  constructor(call: InitializeAnyApiOperatorCall) {
    this._call = call;
  }
...
export class InitializeAnyApiOperatorCall__Outputs {
  _call: InitializeAnyApiOperatorCall;
